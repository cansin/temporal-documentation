...
On Temporal Cloud, use the Temporal Cloud UI to create and manage a Namespace from the UI, or [tcld commands](https://docs.temporal.io/cloud/tcld/namespace/) to manage Namespaces from the command-line interface.
...
On Temporal Cloud, use the Temporal Cloud UI or [tcld commands](https://docs.temporal.io/cloud/tcld/namespace/) to create Namespaces.
...
On Temporal Cloud, use the Temporal Cloud UI or [tcld commands](https://docs.temporal.io/cloud/tcld/namespace/) to manage Namespaces.
