...
![Temporal Web UI showing stripped "Workflow Type" entries, in this case the single letter 's'](/img/stripped_workflow_types_in_webui.png)
...
- Restarting and resetting Workflows by ID
- Resetting all Workflows by binary checksum identifier
