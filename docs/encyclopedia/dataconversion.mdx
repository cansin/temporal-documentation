...
For details, see the API references: [TypeScript](https://typescript.temporal.io/api/interfaces/common.DataConverter)
...
To encode this data, specify your Codec Server endpoints](#codec-server) with [the Temporal CLI and configure your Web UI to use the Codec Server endpoints.
...
Samples: [TypeScript](https://github.com/temporalio/samples-typescript/tree/main/encryption)
...
Most SDKs provide example Codec Server implementation samples, listed here: [TypeScript](https://github.com/temporalio/samples-typescript/blob/main/encryption/src/codec-server.ts)
