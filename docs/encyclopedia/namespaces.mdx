...
- **Namespace Configuration:** Various configuration options like the Retention Period](/clusters#retention-period) and the [Archival](/clusters#archival) destination are configured per Namespace through a special CRUD API or through the [Temporal CLI.
...
- Use the `temporal operator namespace create` or `temporal operator namespace update` command with the `--retention` modfiier to register your Namespaces, one at a time, and set the Retention Period on each.
  ...
  - How to create a new Namespace using the Temporal CLI
  - [How to create a new Namespace using the Typescript SDK](/develop/typescript/namespaces#register-namespace)
...
- [How to manage Namespaces using the Typescript SDK](/develop/typescript/namespaces#manage-namespaces)

- Update information and configuration for a registered Namespace on your Temporal Service:

  - With the Temporal CLI: `temporal operator namespace update`
...
- How to list Namespaces in a Temporal Service using the Temporal CLI
- How to view (describe) Namespace metadata and details using the Temporal CLI
...
- How to register a Global Namespace
- How to change the active Cluster for a Global Namespace
